            ...
            <div className='container'>
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo1.png" width={140}></img>
                ...
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo2.png" width={140}></img>
                ...
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo3.png" width={140}></img>
                ...
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo4.png" width={140}></img>
                ...
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo5.png" width={140}></img>
                ...
                <div className="card flex-col">
                    <div className='flex card_menu'>
                        <img src="/public/photo6.png" width={140}></img>
                        <h2 className="  [writing-mode:vertical-rl] text-xs artist">DEVELOPER</h2>
                    </div>
